...
cp /mnt/Storage1/nextcloud/html/config/config.php /mnt/Storage1/nextcloud/html/config/config.php.bak

# Add the LAN IP to the config.php file
awk -v ip="$lan_ip" '/0 => '\''localhost'\''/{print; print "    1 => '\''"ip"'\'',"; next}1' /mnt/Storage1/nextcloud/html/config/config.php.bak > /mnt/Storage1/nextcloud/html/config/config.php
